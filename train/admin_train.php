					...
					<div class="box-head">
						...
						?>
							...
							<tr>
							  ...
							  <td align="center">
							  <a href="viewtrain.php? train_id=<?php echo $tr[0];?>">VIEW DETAILS</a> | <a href="edit_train.php? train_id=<?php echo $tr[0];?>">EDIT</a> | <a href="delete_train.php? train_id=<?php echo $tr[0];?>">DELETE</a>
							  </td>
							</tr>
